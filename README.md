...
<p align="center">
  ...
  Si vous souhaitez naviguer totalement comme à l'époque en 1200 bauds, il faut utiliser l'option <b>/nospeed</b>.<br><br>
  Un câble USB -> DIN Minitel sera utilisé pour la liaison entre le PC et le Minitel<br>
  (Vous pouvez trouver de très bons câbles Minitel sur eBay chez le sympathique vendeur R‑Ecommerce)<br><br>
