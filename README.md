...
Un câble USB -> DIN Minitel sera utilisé pour la liaison entre le PC et le Minitel<br><br>
Grâce à Jean-arthur Silve (un grand merci à lui pour son travail) qui a créé MiniPavi et à l'excellent émulateur Minitel développé par Frédéric BISSON,<br> une connexion est également possible en cliquant sur le lien suivant:<br>
